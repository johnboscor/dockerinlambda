...
def create_tech_flags(
    ...
    job_title_col_name,
    job_description_col,
    reference_tech_words_path='scripts/developing_tech_flag_files/technical_flag_reference_tech_words.xlsx'
    ):
    ...
    output_data = tech_tag(input_file_path, job_description_col, mappedTokenText, mappedTokenTitle)
...
def main():
    input_file_path = 'scripts/developing_tech_flag_files/sample_job_descriptions.csv'
    ...
    result = create_tech_flags(input_file_path, output_file_path, job_title_col_name, job_description_col)
    return result
