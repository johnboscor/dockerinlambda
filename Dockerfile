...
COPY data/input/female_applicant_prediction_reference_data.csv "${WORKING_DIR}/data/input/"
COPY data/input/technical_flag_reference_tech_words.xlsx "{WORKING_DIR}/data/input/"
...
CMD conda run --name job_ads uvicorn app.main:inclusivity_rating_api --host "0.0.0.0" --port 8000
